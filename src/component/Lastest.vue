...
<template>
    <section class="pt-[30px] md:pt-[40px]">
        <div class="container lg:max-w-[1200px] mx-auto px-[24px] md:px-0">
            <div class="grid grid-cols-2 md:grid-cols-2 ">
                <div class="flex gap-1 flex-wrap">
                    <h1 class="text-[18px] leading-[21.6px] md:text-[40px] md:leading-[48px] font-semibold font-bricolage text-black">Lastest</h1>
                    <h1 class="text-[18px] leading-[21.6px] md:text-[40px] md:leading-[48px] font-semibold font-bricolage text-red-600">News</h1>
                </div>
        ...
        <!-- Cards -->
        <div class="grid grid-cols-2 md:grid-cols-4 gap-6 mt-[20px] ">
            <div v-for="card in cards" :key="card.title" class="">
                ...
                <div class="flex justify-between mt-[14px]">
                    <div class="border-l-4 border-black">
                        <p class="ml-[10px] text-[14px] leading-[14px] md:text-[16px] md:leading-[16px] font-bold font-bricolage text-[#002E40]">{{ card.author }}</p>
                    </div>
                    <p class="text-[12px] leading-[12px]  text-[#002E40] font-bricolage">{{ card.date }}</p>
                </div>
                <p class="text-[12px] leading-[15.6px] md:text-[20px] md:leading-[26px] font-semibold text-[#1D1717] mt-[12px]">{{ card.title }}</p>
            </div>
        </div>
    </div>
    </section>
