        ...
        <div class="container lg:max-w-[1200px] mx-auto px-[24px] md:px-0">
            ...
            <div class="grid grid-cols-2 md:grid-cols-4 gap-6 mt-[20px] ">
                <div v-for="card in cards" :key="card.title" class="">
                    <img :src="card.image" alt="image" class="w-[full] h-auto" />
                    <div class="flex mt-[14px] justify-between">
                        ...
                        <p class="text-[12px] mx-[10px] leading-[12px]  text-[#002E40] font-bricolage">{{ card.date }}</p>
                    </div>
                    <p
                        class="text-[12px] leading-[15.6px] md:text-[20px] md:leading-[26px] font-bricolage font-semibold text-[#1D1717] pt-[12px] md:pt-[14px]">
                        {{ card.title }}</p>
                </div>
            </div>
        </div>
